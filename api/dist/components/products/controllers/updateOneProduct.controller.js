...
const updateOneProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedProduct = yield services.updateOneProduct(id, name, description, price, expirationDate);
        ...
        if (err instanceof StatusError_1.StatusError) {
            ...
            const statusError = new StatusError_1.StatusError("Internal Server Error", 500);
            next(statusError);
        }
    }
});

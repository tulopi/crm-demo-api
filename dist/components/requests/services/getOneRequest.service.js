...
const getOneRequest = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const request = yield requests_model_1.default.findById(id);
    if (!request)
        throw new StatusError_1.StatusError("No se han encontrado el request solicitado en la base de datos.", 400);
    return request;
});
